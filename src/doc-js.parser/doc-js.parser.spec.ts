...
describe('#DocJsParser', () => {
  ...
  test('#GetProperties -> getPropsFromStatic', () => {
    ...
    const output1 = [{
      ...
      "required": null,
      "name": "contextTypes",
      "shortDescription": "Another static property",
      "description": "Another static property"
    }];
    const test2 = {};
  ...
  test('#GetMethods -> getType', () => {
    ...
    expect(methods.getType(test1).toString()).toBe(['array'].toString());
    ...
    const output1 = [
      {
        ...
        "isStatic": false,
        "shortDescription": "used to compile rkTypes",
        "description": ""
      },
      {
        "examples": [],
        ...
        "isStatic": false,
        "shortDescription": "Extracts non style value",
        "description": ""
      }
    ];
    const test2 = {};

    expect(methods.getMethodsInstance(test1).toString()).toBe(output1.toString());
    expect(methods.getMethodsInstance(test2).toString()).toBe([].toString());
  });
    ...
    const output1 = [
      {
        "examples": [
          {
            "shortDescription": "Just a sample of example code",
            "description": "//...",
            "code": "\nimport {RkButton} from 'react-native-ui-kitten';\n\n//...\n\n<RkButton\nstyle={{backgroundColor: 'example'}}\ncontentStyle={{color: 'white'}}> Hello </RkButton>\n"
          }
        ],
        ...
        "isStatic": true,
        "shortDescription": "Add new color to theme STATIC",
        "description": ""
      }
    ];
    const test2 = {};

    expect(methods.getMethodsStatic(test1).toString()).toBe(output1.toString());
    expect(methods.getMethodsStatic(test2).toString()).toBe([].toString());
  });
